...
<div class="card-body">
    <div class="row">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{URL::to('/update_dspm/'.$edit->id)}}" method="post" enctype="multipart/form-data">
              	@csrf
                <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                    ...
                                    <div class="icheck-success d-inline">
                                        <input type="radio" id="DSPM_01_2" name="DSPM_01" checked value="1">
                                ...
                                @endphp   
                                    <div class="icheck-success d-inline">
                                        <input type="radio" id="DSPM_01_1" name="DSPM_01" checked value="0">
                                        <label for="DSPM_01_1" >ผ่าน</label>
                                    </div>
                                    <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_02_2" name="DSPM_02" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_02_1" name="DSPM_02" checked value="0">
                                            <label for="DSPM_02_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">   
                                            <input type="radio" id="DSPM_03_2" name="DSPM_03" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">                                
                                            <input type="radio" id="DSPM_03_1" name="DSPM_03" checked value="0">
                                            <label for="DSPM_03_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">   
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_04_2" name="DSPM_04" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">                                
                                            <input type="radio" id="DSPM_04_1" name="DSPM_04" checked value="0">
                                            <label for="DSPM_04_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_05_2" name="DSPM_05" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_05_1" name="DSPM_05" checked value="0">
                                            <label for="DSPM_05_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_06_2" name="DSPM_06" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_06_1" name="DSPM_06" checked value="0">
                                            <label for="DSPM_06_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_07_2" name="DSPM_07" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_07_1" name="DSPM_07" checked value="0">
                                            <label for="DSPM_07_1">ผ่าน</label>
                                        </div>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_08_2" name="DSPM_08" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_08_1" name="DSPM_08" checked value="0">
                                            <label for="DSPM_08_1" >ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_09_2" name="DSPM_09" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_09_1" name="DSPM_09" checked value="0">
                                            <label for="DSPM_09_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_10_2" name="DSPM_10" checked value="1">
                                ...
                                @endphp   
                                         <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_10_1" name="DSPM_10" checked value="0">
                                            <label for="DSPM_10_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_11_2" name="DSPM_11" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_11_1" name="DSPM_11" checked value="0">
                                            <label for="DSPM_11_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_12_2" name="DSPM_12" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_12_1" name="DSPM_12" checked value="0">
                                            <label for="DSPM_12_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_13_2" name="DSPM_13" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_13_1" name="DSPM_13" checked value="0">
                                            <label for="DSPM_13_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_14_2" name="DSPM_14" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_14_1" name="DSPM_14" checked value="0">
                                            <label for="DSPM_14_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_15_2" name="DSPM_15" checked value="1">
                                ...
                                @endphp   
                                <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_15_1" name="DSPM_15" checked value="0">
                                            <label for="DSPM_15_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_16_2" name="DSPM_16" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_16_1" name="DSPM_16" checked value="0">
                                            <label for="DSPM_16_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_17_2" name="DSPM_17" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_17_1" name="DSPM_17"checked value="0">
                                            <label for="DSPM_17_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_18_2" name="DSPM_18" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_18_1" name="DSPM_18" checked value="0">
                                            <label for="DSPM_18_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_19_2" name="DSPM_19" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_19_1" name="DSPM_19" checked value="0">
                                            <label for="DSPM_19_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_20_2" name="DSPM_20" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_20_1" name="DSPM_20" checked value="0">
                                            <label for="DSPM_20_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_21_2" name="DSPM_21" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_21_1" name="DSPM_21" checked value="0">
                                            <label for="DSPM_21_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_22_2" name="DSPM_22" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_22_1" name="DSPM_22" checked value="0">
                                            <label for="DSPM_22_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_23_2" name="DSPM_23" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_23_1" name="DSPM_23" checked value="0">
                                            <label for="DSPM_23_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_24_2" name="DSPM_24" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_24_1" name="DSPM_24" checked value="0">
                                            <label for="DSPM_24_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_25_2" name="DSPM_25" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_25_1" name="DSPM_25" checked value="0">
                                            <label for="DSPM_25_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_26_2" name="DSPM_26" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_26_1" name="DSPM_26" checked value="0">
                                            <label for="DSPM_26_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_27_2" name="DSPM_27" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_27_1" name="DSPM_27" checked value="0">
                                            <label for="DSPM_27_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_28_2" name="DSPM_28" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_28_1" name="DSPM_28" checked value="0">
                                            <label for="DSPM_28_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_29_2" name="DSPM_29" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_29_1" name="DSPM_29" checked value="0">
                                            <label for="DSPM_29_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_30_2" name="DSPM_30" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_30_1" name="DSPM_30" checked value="0">
                                            <label for="DSPM_30_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_31_2" name="DSPM_31" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_31_1" name="DSPM_31" checked value="0">
                                            <label for="DSPM_31_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_32_2" name="DSPM_32" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_32_1" name="DSPM_32" checked value="0">
                                            <label for="DSPM_32_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_33_2" name="DSPM_33" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_33_1" name="DSPM_33" checked value="0">
                                            <label for="DSPM_33_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_34_2" name="DSPM_34" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_34_1" name="DSPM_34" checked value="0">
                                            <label for="DSPM_34_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_35_2" name="DSPM_35" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_35_1" name="DSPM_35" checked value="0">
                                            <label for="DSPM_35_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_36_2" name="DSPM_36" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_36_1" name="DSPM_36" checked value="0">
                                            <label for="DSPM_36_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_37_2" name="DSPM_37" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_37_1" name="DSPM_37" checked value="0">
                                            <label for="DSPM_37_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_38_2" name="DSPM_38" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_38_1" name="DSPM_38" checked value="0">
                                            <label for="DSPM_38_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_39_2" name="DSPM_39" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_39_1" name="DSPM_39" checked value="0">
                                            <label for="DSPM_39_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_40_2" name="DSPM_40" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_40_1" name="DSPM_40" checked value="0">
                                            <label for="DSPM_40_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_41_2" name="DSPM_41" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_41_1" name="DSPM_41" checked value="0">
                                            <label for="DSPM_41_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_42_2" name="DSPM_42" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_42_1" name="DSPM_42" checked value="0">
                                            <label for="DSPM_42_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_43_2" name="DSPM_43" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_43_1" name="DSPM_43" checked value="0">
                                            <label for="DSPM_43_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_44_2" name="DSPM_44" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_44_1" name="DSPM_44" checked value="0">
                                            <label for="DSPM_44_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_45_2" name="DSPM_45" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_45_1" name="DSPM_45" checked value="0">
                                            <label for="DSPM_45_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_46_2" name="DSPM_46" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_46_1" name="DSPM_46" checked value="0">
                                            <label for="DSPM_46_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_47_2" name="DSPM_47" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_47_1" name="DSPM_47" checked value="0">
                                            <label for="DSPM_47_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_48_2" name="DSPM_48" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_48_1" name="DSPM_48" checked value="0">
                                            <label for="DSPM_48_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_49_2" name="DSPM_49" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_49_1" name="DSPM_49" checked value="0">
                                            <label for="DSPM_49_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_50_2" name="DSPM_50" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_50_1" name="DSPM_50" checked value="0">
                                            <label for="DSPM_50_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_51_2" name="DSPM_51" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_51_1" name="DSPM_51" checked value="0">
                                            <label for="DSPM_51_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_52_2" name="DSPM_52" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_52_1" name="DSPM_52" checked value="0">
                                            <label for="DSPM_52_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_53_2" name="DSPM_53" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_53_1" name="DSPM_53" checked value="0">
                                            <label for="DSPM_53_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_54_2" name="DSPM_54" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_54_1" name="DSPM_54" checked value="0">
                                            <label for="DSPM_54_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_55_2" name="DSPM_55" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_55_1" name="DSPM_55" checked value="0">
                                            <label for="DSPM_55_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_56_2" name="DSPM_56" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_56_1" name="DSPM_56" checked value="0">
                                            <label for="DSPM_56_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_57_2" name="DSPM_57" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_57_1" name="DSPM_57" checked value="0">
                                            <label for="DSPM_57_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_58_2" name="DSPM_58" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_58_1" name="DSPM_58" checked value="0">
                                            <label for="DSPM_58_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_59_2" name="DSPM_59" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_59_1" name="DSPM_59" checked value="0">
                                            <label for="DSPM_59_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_60_2" name="DSPM_60" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_60_1" name="DSPM_60" checked value="0">
                                            <label for="DSPM_60_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_61_2" name="DSPM_61" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_61_1" name="DSPM_61" checked value="0">
                                            <label for="DSPM_61_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_62_2" name="DSPM_62" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_62_1" name="DSPM_62" checked value="0">
                                            <label for="DSPM_62_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_63_2" name="DSPM_63" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_63_1" name="DSPM_63" checked value="0">
                                            <label for="DSPM_63_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_64_2" name="DSPM_64" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_64_1" name="DSPM_64" checked value="0">
                                            <label for="DSPM_64_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_65_2" name="DSPM_65" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_65_1" name="DSPM_65" checked value="0">
                                            <label for="DSPM_65_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_66_2" name="DSPM_66" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_66_1" name="DSPM_66" checked value="0">
                                            <label for="DSPM_66_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_67_2" name="DSPM_67" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_67_1" name="DSPM_67" checked value="0">
                                            <label for="DSPM_67_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_68_2" name="DSPM_68" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_68_1" name="DSPM_68" checked value="0">
                                            <label for="DSPM_68_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_69_2" name="DSPM_69" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_69_1" name="DSPM_69" checked value="0">
                                            <label for="DSPM_69_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_70_2" name="DSPM_70" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_70_1" name="DSPM_70" checked value="0">
                                            <label for="DSPM_70_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_71_2" name="DSPM_71" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_71_1" name="DSPM_71" checked value="0">
                                            <label for="DSPM_71_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_72_2" name="DSPM_72" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_72_1" name="DSPM_72" checked value="0">
                                            <label for="DSPM_72_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_73_2" name="DSPM_73" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_73_1" name="DSPM_73" checked value="0">
                                            <label for="DSPM_73_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_74_2" name="DSPM_74" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_74_1" name="DSPM_74" checked value="0">
                                            <label for="DSPM_74_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_75_2" name="DSPM_75" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_75_1" name="DSPM_75" checked value="0">
                                            <label for="DSPM_75_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_76_2" name="DSPM_76" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_76_1" name="DSPM_76" checked value="0">
                                            <label for="DSPM_76_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_77_2" name="DSPM_77" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_77_1" name="DSPM_77" checked value="0">
                                            <label for="DSPM_77_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_78_2" name="DSPM_78" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_78_1" name="DSPM_78" checked value="0">
                                            <label for="DSPM_78_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_79_2" name="DSPM_79" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_79_1" name="DSPM_79" checked value="0">
                                            <label for="DSPM_79_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_80_2" name="DSPM_80" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_80_1" name="DSPM_80" checked value="0">
                                            <label for="DSPM_80_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_81_2" name="DSPM_81" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_81_1" name="DSPM_81" checked value="0">
                                            <label for="DSPM_81_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_82_2" name="DSPM_82" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_82_1" name="DSPM_82" checked value="0">
                                            <label for="DSPM_82_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_83_2" name="DSPM_83" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_83_1" name="DSPM_83" checked value="0">
                                            <label for="DSPM_83_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_84_2" name="DSPM_84" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_84_1" name="DSPM_84" checked value="0">
                                            <label for="DSPM_84_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_85_2" name="DSPM_85" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_85_1" name="DSPM_85" checked value="0">
                                            <label for="DSPM_85_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_86_2" name="DSPM_86" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_86_1" name="DSPM_86" checked value="0">
                                            <label for="DSPM_86_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_87_2" name="DSPM_87" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_87_1" name="DSPM_87" checked value="0">
                                            <label for="DSPM_87_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_88_2" name="DSPM_88" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_88_1" name="DSPM_88" checked value="0">
                                            <label for="DSPM_88_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_89_2" name="DSPM_89" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_89_1" name="DSPM_89" checked value="0">
                                            <label for="DSPM_89_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_90_2" name="DSPM_90" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_90_1" name="DSPM_90" checked value="0">
                                            <label for="DSPM_90_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_91_2" name="DSPM_91" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_91_1" name="DSPM_91" checked value="0">
                                            <label for="DSPM_91_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_92_2" name="DSPM_92" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_92_1" name="DSPM_92" checked value="0">
                                            <label for="DSPM_92_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_93_2" name="DSPM_93" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_93_1" name="DSPM_93" checked value="0">
                                            <label for="DSPM_93_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_94_2" name="DSPM_94" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_94_1" name="DSPM_94" checked value="0">
                                            <label for="DSPM_94_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_95_2" name="DSPM_95" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_95_1" name="DSPM_95" checked value="0">
                                            <label for="DSPM_95_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_96_2" name="DSPM_96" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_96_1" name="DSPM_96" checked value="0">
                                            <label for="DSPM_96_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_97_2" name="DSPM_97" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_97_1" name="DSPM_97" checked value="0">
                                            <label for="DSPM_97_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_98_2" name="DSPM_98" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_98_1" name="DSPM_98" checked value="0">
                                            <label for="DSPM_98_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_99_2" name="DSPM_99" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_99_1" name="DSPM_99" checked value="0">
                                            <label for="DSPM_99_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_100_2" name="DSPM_100" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_100_1" name="DSPM_100" checked value="0">
                                            <label for="DSPM_100_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_101_2" name="DSPM_101" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_101_1" name="DSPM_101" checked value="0">
                                            <label for="DSPM_101_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_102_2" name="DSPM_102" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_102_1" name="DSPM_102" checked value="0">
                                            <label for="DSPM_102_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_103_2" name="DSPM_103" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_103_1" name="DSPM_103" checked value="0">
                                            <label for="DSPM_103_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_104_2" name="DSPM_104" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_104_1" name="DSPM_104" checked value="0">
                                            <label for="DSPM_104_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_105_2" name="DSPM_105" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_105_1" name="DSPM_105" checked value="0">
                                            <label for="DSPM_105_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_106_2" name="DSPM_106" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_106_1" name="DSPM_106" checked value="0">
                                            <label for="DSPM_106_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_107_2" name="DSPM_107" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_107_1" name="DSPM_107" checked value="0">
                                            <label for="DSPM_107_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_108_2" name="DSPM_108" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_108_1" name="DSPM_108" checked value="0">
                                            <label for="DSPM_108_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_109_2" name="DSPM_109" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_109_1" name="DSPM_109" checked value="0">
                                            <label for="DSPM_109_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_110_2" name="DSPM_110" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_110_1" name="DSPM_110" checked value="0">
                                            <label for="DSPM_110_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_111_2" name="DSPM_111" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_111_1" name="DSPM_111" checked value="0">
                                            <label for="DSPM_111_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_112_2" name="DSPM_112" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_112_1" name="DSPM_112" checked value="0">
                                            <label for="DSPM_112_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_113_2" name="DSPM_113" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_113_1" name="DSPM_113" checked value="0">
                                            <label for="DSPM_113_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_114_2" name="DSPM_114" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_114_1" name="DSPM_114" checked value="0">
                                            <label for="DSPM_114_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_115_2" name="DSPM_115" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_115_1" name="DSPM_115" checked value="0">
                                            <label for="DSPM_115_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">
                            ...
                            <td align="center">
                                ...
                                @endphp 
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_116_2" name="DSPM_116" checked value="1">
                                ...
                                @endphp   
                                        <div class="icheck-success d-inline">
                                            <input type="radio" id="DSPM_116_1" name="DSPM_116" checked value="0">
                                            <label for="DSPM_116_1">ผ่าน</label>
                                        </div>
                                        <div class="icheck-success d-inline">

<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: #866ec7;">
    <!-- Brand Logo -->
    <a href="#" class="brand-link">
      <img src="{{('/backend/dist/img/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Early childhood</span>
    </a>

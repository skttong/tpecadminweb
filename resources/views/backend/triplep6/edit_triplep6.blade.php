...
<div class="card-body">
    <div class="row">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{URL::to('/update_triplep6/'.$edit->id)}}" method="post" enctype="multipart/form-data">
              	@csrf
                <div class="card-body">
...
<input type="text" name="name" value="{{$edit->r1}}"  class="form-control @error('title') is-invalid @enderror"
